...
#
# Storefront is an Apple Silicon-only app (see ARCHS in project.yml), but Sparkle ships
# universal, so roughly half of Contents/Frameworks is dead x86_64 weight.
#
...
#
#     thin-frameworks.sh Storefront.app && release-dmg.sh Storefront.app
set -euo pipefail
